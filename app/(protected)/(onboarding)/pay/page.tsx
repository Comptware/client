...
import { useCreateBitpayInvoiceMutation, useCreateDepositIntentMutation, useCreatePaymentIntentMutation } from "@/store/features/payment/paymentApi";
      ...
      <section id="Intro" className="pt-20 pb-10">
        <div className="container">
          ...
          <div className="flex max-w-full md:mx-auto mx-4 relative mt-4">
            <div className="flex-1 relative">
            <p className="md:text-2xl text-xl text-dark mb-4 md:text-left text-center">Payment options</p>
            <p className="md:text-2xl text-xl text-primary mb-4 md:text-left text-center">Select what works best for you:</p>
            </div>
          </div>
                  ...
                  <div className="py-4 w-full lg:max-w-lg">
                    <section id="payment-option">
                      <button
                        ...
                        <h1 className="md:text-lg text-sm font-black">Purchase Bundle</h1>
                        ...
                        <p className="md:text-sm text-xs mb-4">Pay with crypto, wire transfer or credit card</p>
                      </button>
                      <button 
                        onClick={() => onSelectPaymentOptions('finance')}
                        className={`rounded-2xl hover:bg-sky-blue hover:shadow-md mb-8 border border-primary p-5 text-left w-full
                        ${ paymentOption === 'finance' ? 'bg-sky-blue' : ''}`}>
                        <h1 className="md:text-lg text-sm font-black">Finance Bundle</h1>
                        <p className="md:text-sm text-xs mb-4">ABC Finance company Monthly Installments</p>
                        <hr className="border-dark my-4 w-full" />
                        <p className="md:text-sm text-xs">$999.00/mo for XX  months*</p>
                    ...
                    { !payment && paymentOption === 'finance' && (
                      <section id="payment-option ">
                        <div className="mb-8 p-5 text-center">
                          <h1 className="md:text-lg text-sm text-red-600">Coming Soon</h1>
                        </div>
                      </section>
                    )}
                    <section id="payment-option">
        ...
        <PaymentAgreementModal isOpen={agreementOpen} onClose={() => setAgreementOpen(false)}>
        <div className="max-h-[60vh] overflow-y-auto mb-4">
          <h2 className="text-xl font-semibold mb-4">Payment Agreement</h2>
          <h4 className="text-lg font-semibold mb-4">General</h4>
          <p className="text-gray-700 mb-4">These Payment Terms describe your agreement to pay for current and future goods and services, together with any charges or fees applied by us related to goods or services. In these Payment Terms, &apos;we&apos; and &apos;us&apos; mean the SunCore Digital group entity supplying the goods and services in your country.</p>
          <p className="text-gray-700 mb-4">To use services like Bitcoin wallet deposits or SunCore&apos;s zero-energy-cost Bitcoin mining platform, you authorize SunCore Digital to store and validate your payment method as stated in these Payment Terms.  SunCore Digital LLC may amend these terms from time to time, and any changes are effective when posted to this page.</p>
          <p className="text-gray-700 mb-4">Following your initial non-refundable deposit, a SunCore Digital Ambassador will contact you to finalize your hardware purchase and go over all payment options to initiate the onboarding process to becoming a SunCore client.</p>  
          <p className="text-gray-700 mb-4">When you add a payment method to your SunCore Digital Account, such as a credit card, certain information including, but not limited to device location, device identification number, and card information may be sent to SunCore and shared with our payment processor. Card information is encrypted during the transmission and SunCore will not have access to the actual card number.</p>
          <p className="text-gray-700 mb-4">When the stored payment method or a new credit card is used for purchasing goods and services on a SunCore hosted website or application, the necessary information to process payment will be shared with our global processors and our banking partners, to process your payment, comply with financial regulations, to prevent fraud, and for troubleshooting any payment issues.</p>
          <p className="text-gray-700 mb-4">When you pay using your bank account details, those details are stored by SunCore Digital in an encrypted format that prevents unauthorized access without specific permissions. For information on how we handle your payment information, please see Suncore&apos;s <a href="#" className="text-primary">Privacy Notice.</a></p>
          <p className="text-gray-700 mb-4">You must maintain at least one valid payment method in your SunCore Account at the commencement of each earnings cycle.  Every SunCore client is granted a cashless ASIC upgrade option at the commencement of each cycle.  Non-cashless upgrade accounts must maintain a valid payment method to avoid service interruptions mid-cycle and remain in good standing.</p>
          <p className="text-gray-700 mb-4">Any services received may result in charges being applied to your saved payment method, and charges may include taxes as required by law. Your failure to maintain accurate, complete, and up-to-date payment information, including an invalid or expired payment method, may result in account termination.</p>
          <p className="text-gray-700 mb-4">If any attempt to recover funds from you should fail using the payment method saved in your SunCore Account, you agree to allow SunCore Digital LLC to recover all or less than all of the amount owed for goods or services as set out in this clause. If we are unable to collect payment, we may contact you based on your information on file or may request payment when we are performing services for you until these issues are resolved.</p>
        </div>
        <button
