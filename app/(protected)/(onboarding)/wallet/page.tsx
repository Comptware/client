...
type WalletOption = "suncore" | "personal";

const WALLET_STORAGE_KEY = "suncore-wallet-option";
const WALLET_COOKIE = "suncore-wallet-selected";

export default function WalletPage() {
  const [activeIndex, setActiveIndex] = useState<number | null>(1);
  const [walletOption, setWalletOption] = useState<WalletOption>("suncore");
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem(
      WALLET_STORAGE_KEY
    ) as WalletOption | null;
    if (saved === "suncore" || saved === "personal") {
      setWalletOption(saved);
    }
  }, []);

  const onSelectWalletOptions = (option: WalletOption) => {
    setWalletOption(option);
    if (typeof window !== "undefined") {
      localStorage.setItem(WALLET_STORAGE_KEY, option);
    }
  };
  ...
  const handleNext = () => {
    ...
    localStorage.setItem(WALLET_STORAGE_KEY, walletOption);
    const secure = window.location.protocol === "https:" ? "; secure" : "";
    document.cookie = `${WALLET_COOKIE}=${walletOption}; path=/; max-age=31536000; samesite=lax${secure}`;
  };
        ...
        <div className="container">
          ...
          <div className="flex max-w-full md:mx-auto mx-4 relative mt-4">
            <div className="flex-1 relative">
              ...
              <p className="md:text-lg text-sm text-dark mb-4 md:text-left text-center">
                You can receive your mining deposits directly to a SunCore +
                Ledger Hard Wallet or your own Bitcoin wallet.
              </p>
            </div>
          </div>
            ...
            <div className="flex gap-4 relative">
              ...
              >
                <h1 className="md:text-lg text-sm font-black">
                  Use SunCore + Ledger Hard Wallet
                </h1>
              </button>
              <button
            ...
            <>
              <div className="flex max-w-full md:mx-auto mx-4 relative mt-8">
                <div className="flex-1 relative">
                  ...
                  <p className="md:text-lg text-sm text-dark mb-4 md:text-left text-center">
                    Make sure all information is correct — transactions
                    can&apos;t be reversed once sent.
                  </p>
                </div>
              </div>
              <div className="flex flex-col bg-shadow-gray/40 rounded-2xl max-w-full md:mx-auto mx-4 p-8 relative mt-4">
                <div className="w-full">
                  <p className="md:text-2xl text-xl text-dark mb-4 md:text-left text-center">
                    Select the kind of wallet where you want to receive your
                    deposits.
                  </p>
                </div>
                <div className="w-full">
                        ...
                        <div className="p-4 text-gray-600">
                          <div className="mb-4">
                            <label className="flex items-center space-x-3 cursor-pointer">
                              ...
                              <span className="text-gray">
                                Personal / Non-custodial (e.g., Ledger, Trezor,
                                MetaMask)
                              </span>
                            </label>
                          </div>
                          <div className="mb-4">
                            <label className="flex items-center space-x-3 cursor-pointer">
                              ...
                              />
                              <span className="text-gray">
                                Custodial exchange (e.g., Coinbase, Kraken,
                                Binance)
                              </span>
                            </label>
                          </div>
                        ...
                        <div className="p-4 text-gray-600">
                          ...
                          <div className="mb-4">
                            <label className="flex items-center space-x-3 cursor-pointer">
                              ...
                              />
                              <span className="text-gray">
                                Lightning Network (advanced users)
                              </span>
                            </label>
                          </div>
                          <div className="mb-4">
                          ...
                          <div className="mb-4">
                            <div className="font-medium">
                              Confirm BTC deposit address
                            </div>
                            <div className="mr-8">
                              (Please re-enter to confirm. Address must match
                              exactly.)
                            </div>
                          </div>
                          <div className="mb-4">
                      ...
                      {activeIndex === 3 && (
                        ...
                        >
                          <div className="p-4 text-gray-600">
                            <div className="mb-4">
                              <div className="w-full">
                                Deposit tag / memo / reference ID
                              </div>
                              <div className="mr-8">
                                (Some exchanges require this for routing.)
                              </div>
                            </div>
                            <div className="mb-4">
                              <input
                          ...
                          <div className="mb-4">
                            <label className="flex items-center space-x-3 cursor-pointer">
                              ...
                              <span className="text-gray">
                                ...
                                <p>
                                  I understand SunCore may send a small test
                                  transaction to verify this address before
                                  regular deposits begin.
                                </p>
                              </span>
                            </label>
                          </div>
                          <div className="mb-4">
                            <label className="flex items-center space-x-3 cursor-pointer">
                              ...
                              <span className="text-gray">
                                ...
                                <p>
                                  I confirm this is my own Bitcoin wallet and
                                  that I have full access and control of the
                                  funds.
                                </p>
                              </span>
                            </label>
